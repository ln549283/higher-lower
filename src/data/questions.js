const groups = [
  {
    category: 'Hauteur des sommets', unit: 'm',
  ...
  {
    category: 'Longueur des fleuves', unit: 'km',
  ...
  {
    category: 'Superficie des pays', unit: 'km²',
  ...
  {
    category: 'Superficie des îles', unit: 'km²',
  ...
  {
    category: 'Point de fusion des métaux', unit: '°C',
  ...
  {
    category: 'Vitesse maximale approximative', unit: 'km/h',
  ...
  {
    category: 'Durée de gestation moyenne', unit: 'jours',
  ...
  {
    category: 'Profondeur maximale', unit: 'm',
  ...
  {
    category: 'Année de première sortie', unit: '',
